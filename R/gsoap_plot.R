...
#'
#' @return A plot where individual instances are represented by circles,
#' whose size reflects the number of genes members of the given instance,
#' and whose proximity reflects the number common gene members.
...
#' More description
#'
#' @param layout a data frame with the result of the \code{\link{create_gsoap_layout}}.
#' @param as.color a character or integer, indicating name or index of the column used as color aesthetic.
#' @param as.alpha a character or integer, indicating name or index of the column used as alpha aesthetic.
#' @param which.labels a character or integer vector, indicating the rows whose names should be show in the plot
#' @param show.size.guide a boolean indicate whether to show size guide.
#' @param show.color.guide a boolean indicate whether to show color guide.
#' @param size.guide.loc a numeric vector of length 2 with the size guide x and y coordinates.
#' @param size.guide.no a integer indicating number of circles of the size guide.
#' @param default.color a character indicating which color to be used if no color aesthetics is used.
#' @param default.alpha a character indicating which color to be used if no alpha aesthetics is used.
#' @param range.alpha = a numeric vector of length 2 with lower and upper limit of alpha range.
#' @param viridis.option a character vector indicating which of the Viridis color should be used, options are \emph{viridis} (default),
#' \emph{magma}, \emph{plasma}, \emph{inferno}, \emph{cividis}.
...
#' @param label.alpha a positive real indicating the alpha of the labels.
#' @param segment.alpha a positive real number indicating the alpha of the labels repels.
...
#' @param base.fontsize a positive integer indicating base font size.
#' @param size.guide.fontsize a positive integer indicating size guide font size.
#' @param label.fontsize a positive integer indicating labels font size.
#' @param title a text for the title.
#' @param subtitle a text for the subtitle.
#' @param xlabel a text for the x-axis.
#' @param ylabel a text for the y-axis.
#' @param xlimits a numeric vector of length 2 idnicating lower and upper x-axis limits
#' @param ylimits a numeric vector of length 2 idnicating lower and upper y-axis limits
